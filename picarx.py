...
class Picarx(object):
    ...
    CAM_PAN_MIN = -90
    CAM_PAN_MAX = 90
    # REPLICATE PAN SERVO FOR ULTRA SERVO
    CAM_ULTRA_MIN = -90
    CAM_ULTRA_MAX = 90
    CAM_TILT_MIN = -35
    CAM_TILT_MAX = 65
    ...
    def __init__(self, 
                servo_pins:list=['P0', 'P1', 'P2','P3'],    # ADDED P3 HERE FOR ULTRA SERVO 
        ...
        self.cam_ultra = Servo(servo_pins[3])   # ADDED ULTRA
        ...
        self.cam_ultra_cali_val = float(self.config_flie.get("picarx_cam_ultra_servo", default_value=0))    # ADDED ULTRA
    ...
    def cam_ultra_servo_calibrate(self,value):             #########                  # ADDED ULTRA
        ...
        self.confi_flie.set("picarx_cam_ultra_servo", "%s"%value)
    ...
    # ADDED PIVOT RIGHT FUNCTION    
    def left(self,speed):
        #motors = Motors()
        #LEFT = 1
        #RIGHT = 2
        #motors[LEFT].speed(-1*speed)
        #motors[RIGHT].speed(-1*speed)
        self.set_motor_speed(1, -1*speed)
        self.set_motor_speed(2, -1*speed)
    
    # ADDED PIVOT LEFT FUNCTION
